...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        long triggleAtTime = SystemClock.elapsedRealtime() + anHuor;
        Intent i = new Intent(this,AutoUpdateService.class);
        PendingIntent pi = PendingIntent.getService(this,0,i,0);
        alarmManager.cancel(pi);
        alarmManager.set(AlarmManager.ELAPSED_REALTIME_WAKEUP,triggleAtTime,pi);
    ...
    private void updateWeather(){
        ...
        if (weatherString != null){
            ...
            String weatherUrl = WeatherActivity.WEATHER_URL +
                                weatherId +
    ...
    private void updateBingPic(){
        HttpUtil.sendOkhttpRequest(WeatherActivity.REQUESTBINGPIC, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
            }
